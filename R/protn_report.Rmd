...
cat("Barplot showing the count of proteins identified as differentially expressed for each contrast. \n ")
...
cat("Barplot showing the count of peptides identified as differentially expressed for each contrast. \n ")
...
cat("MA plots display log2 fold change versus log2 mean abundance for proteins in each contrast. These plots help identify proteins with significant changes and visualize the relationship between expression level and differential expression. \n ")
cat(" \n \n")
...
cat("MA plots display log2 fold change versus log2 mean abundance for peptides in each contrast. These plots help identify peptides with significant changes and visualize the relationship between expression level and differential expression. \n ")
cat(" \n \n")
...
```{r enrichment, echo=F, message=F, warning=F, eval = length(db_execution$enrichment_results)>0, fig.width=12, results='asis'}
