...
msg <- read_proteomics(software = "MQ",
                                      folder = file_input,
...
msg <- read_proteomics(software = "PD",
                                      folder = file_input)
```
...
```{r boxplot_protein, fig.height=7, fig.width=7,results='asis', echo=FALSE, eval=(length(list_proteins[[1]])>0 & !is.null(db_execution$protein_boxplot))}
