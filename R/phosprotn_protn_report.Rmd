...
cat(" \n")
cat("#### Statistics \n")
cat("The following statistics summarize the input datasets used for the analysis. \n \n ")
...
cat("#### Percentage of phosphosite residue \n ")
cat("The following graph represent the percentage of the phosphosites located on Serine (S), Throenines (T) and Tyrosines (Y). \n ")
cat("\n \n")
...
cat("#### Percentage missing values respect detected abundance - Phospho-proteomics \n ")
...
cat("#### Percentage missing values respect detected abundance - Proteomics \n ")
cat("Barplot showing the percentage of peptides with available abundances for each sample. \n ")
cat("\n \n")
# Avalaible abundance. The red percentage will be imputed.
...
cat("#### N° peptides per proteins - Phospho-proteomics \n")
cat("Barplot showing the number of peptides per a single protein \n ")
...
cat("#### N° peptides per proteins - Proteomics \n")
cat("Barplot showing the number of peptides per a single protein \n ")
# Number peptide per each protein
...
cat("Differentially phosphorylated peptides are identified using the Limma Bioconductor package. In each comparison, phospho-peptide changes are scaled for differences in the corresponding protein levels. PhosProTN also perform phosphorylation enrichment analysis for each condition  \n ")
...
cat("The following table contains the names and the formulas of the contrasts considered for differential phosphorylation analysis.

The conditions from the phospho-proteomics are represented by an **_phospho** at the end of the condition, the **_proteome** represent the conditions from the proteomics. Also, the comparison provided in input by the user are adapted for the differential phosphorylation analysis. \n \n")
