...
cat(paste0("- Imputation algorithm: ",impute_algorithm," "))
cat(" \n \n")
...
```{r read_proteomics_MQ, warning=F, echo=F, eval=F, results='asis'}
messaggi <- NULL
risultato <- withCallingHandlers(
  {
    read_phospho_proteome_proteomics(software = "MQ",
                                     folder_phospho = file_input_phospho,
                                     folder_proteome = file_input_proteome,
...
```{r read_proteomics_PD, warning=F, echo=F, eval=F, results='asis'}
messaggi <- NULL
risultato <- withCallingHandlers(
  {
    read_phospho_proteome_proteomics(software = "PD",
                                     folder_phospho = file_input_phospho,
                                     folder_proteome = file_input_proteome, 
                                     ...
                                     phospho_thr = 0.7, 
                                     sample_proteome_col = "File Name", sample_phospho_col = "File Name")
  },
  message = function(m) {
    messaggi <<- append(messaggi, conditionMessage(m))
    invokeRestart("muffleMessage")
