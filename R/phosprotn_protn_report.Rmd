...
cat("The following graph represents the percentage of phosphosites located on Serine (S), Threonine (T), and Tyrosine (Y). \n ")
cat("\n \n")
...
cat("Barplot showing the number of peptides per protein \n ")
...
cat("Violin plot showing sample distributions of log2 raw abundances. \n ")
#Abundance per raw
...
cat("MA plot log2 FC vs mean of abundance of the conditions in the comparison. \n ")
cat(" \n \n")
...
cat("Differentially expressed proteins are displayed according to the thresholds set in the input. \n ")
...
cat("Differentially expressed peptides are displayed according to the thresholds set in the input. \n ")
cat("\n - \"+\" up-regulated peptide \n ")
cat("\n - \"-\" down-regulated peptide \n ")
cat("\n - \"=\" invariant peptide \n \n ")
cat("Top enriched peptides are labeled. \n")
cat(" \n \n")
